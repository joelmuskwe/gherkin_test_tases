Feature: Site - Homepage
	...
	Background:
		...
		Scenario Outline: I want to use all button and link components in Site - Homepage
			...
			| 855-758-3293 |  Navigation | should open the phone application |
			| Get Pricing | Navigation | should be on "/get-storage-quote" |
			| 855-758-3293 | Reserve Space Form | should open the phone application |
			| Get your price | Ready to Make Space? | should be on "/get-storage-quote" |
			| Get your price | Get your free quote today. | Get your price | should be on "/get-storage-quote" |
			| 855-758-3293 | Get your free quote today. | should open the phone application |
			...
			| 855-758-3293	 | Footer	| should open the phone application |
